...
public class Model extends Application {
    ...
    private final Eroe[] eroi_bene = {
            new Eroe(new Image("file:resources/img/eroi/elrond.png"),
                    new Image("file:resources/img/mini-assets/elrond.png"), "bene", "Elrond"),
            new Eroe(new Image("file:resources/img/eroi/aragorn.png"),
                    new Image("file:resources/img/mini-assets/aragorn.png"), "bene", "Aragorn"),
            new Eroe(new Image("file:resources/img/eroi/gandalf.png"),
                    new Image("file:resources/img/mini-assets/gandalf.png"), "bene", "Gandalf")
    };

    private final Eroe[] eroi_male = {
            new Eroe(new Image("file:resources/img/eroi/sauron.png"),
                    new Image("file:resources/img/mini-assets/sauron.png"), "male", "Sauron"),
            new Eroe(new Image("file:resources/img/eroi/saruman.png"),
                    new Image("file:resources/img/mini-assets/saruman.png"), "male", "Saruman"),
            new Eroe(new Image("file:resources/img/eroi/nazgul.png"),
                    new Image("file:resources/img/mini-assets/nazgul.png"), "male", "Nazgul")
    };
    ...
    public boolean iniziaGioco() {
        ...
        for (int i = 0; i < dim_campo; i++) {
            for (int j = 0; j < dim_campo; j++)
                this.campo[i][j].getStyleClass().add("cornice");
        }
    ...
    public List<Entita> attacco() throws InterruptedException {
        ...
        for (int i = 0; i < campo.length; i++) {
            for (int j = 0; j < campo.length; j++) {
                if (campo[i][j].getClass().getSimpleName().equals("Vuoto"))
                    continue;
                if (campo[i][j].isHaconbattuto())
                    continue;
                if (campo[i][j].getSchieramento().equals("bene")) {
                    if (i != 0 && j != 0 && campo[i - 1][j - 1].getSchieramento().equals("male")
                            && campo[i - 1][j - 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i - 1][j - 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (i != 0 && campo[i - 1][j].getSchieramento().equals("male")
                            && campo[i - 1][j].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i - 1][j]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (i != 0 && j != campo.length - 1 && campo[i - 1][j + 1].getSchieramento().equals("male")
                            && campo[i - 1][j + 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i - 1][j + 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (j != 0 && campo[i][j - 1].getSchieramento().equals("male")
                            && campo[i][j - 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i][j - 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (j != campo.length - 1 && campo[i][j + 1].getSchieramento().equals("male")
                            && campo[i][j + 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i][j + 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (i != campo.length - 1 && j != 0 && campo[i + 1][j - 1].getSchieramento().equals("male")
                            && campo[i + 1][j - 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i + 1][j - 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (i != campo.length - 1 && campo[i + 1][j].getSchieramento().equals("male")
                            && campo[i + 1][j].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i + 1][j]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (i != campo.length - 1 && j != campo.length - 1
                            && campo[i + 1][j + 1].getSchieramento().equals("male")
                            && campo[i + 1][j + 1].isHaconbattuto() == false) {
                        Entita vet[] = duello(campo[i][j], campo[i + 1][j + 1]);
                        lista.add(vet[0]);
                        lista.add(vet[1]);
                    } else if (campo[i][j].getSchieramento().equals("male")) {
                        if (i != 0 && j != 0 && campo[i - 1][j - 1].getSchieramento().equals("bene")
                                && campo[i - 1][j - 1].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i - 1][j - 1]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                        } else if (i != 0 && campo[i - 1][j].getSchieramento().equals("bene")
                                && campo[i - 1][j].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i - 1][j]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                        } else if (i != 0 && j != campo.length - 1
                                && campo[i - 1][j + 1].getSchieramento().equals("bene")
                                && campo[i - 1][j + 1].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i - 1][j + 1]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                        } else if (j != 0 && campo[i][j - 1].getSchieramento().equals("bene")
                                && campo[i][j - 1].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i][j - 1]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                        } else if (j != campo.length - 1 && campo[i][j + 1].getSchieramento().equals("bene")
                                && campo[i][j + 1].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i][j + 1]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                            ...
                            lista.add(vet[0]);
                            lista.add(vet[1]);
                        } else if (i != campo.length - 1 && campo[i + 1][j].getSchieramento().equals("bene")
                                && campo[i + 1][j].isHaconbattuto() == false) {
                            Entita vet[] = duello(campo[i][j], campo[i + 1][j]);
                            lista.add(vet[0]);
                            lista.add(vet[1]);
    ...
    public Entita[] duello(Entita b, Entita m) {
        ...
        if (vet[0].getEsperienza_combattimento() < 10) {
            vet[0].setEsperienza_combattimento(vet[0].getEsperienza_combattimento() + 1);
        }
        vet[1].setMorto(true);
        return vet;
    }
    ...
    public void setVolumeMusica(double volumeMusica) {
